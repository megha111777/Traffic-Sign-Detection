...
#     pickle.dump('model_trained.p', file)
...
# IMPORT THE TRANNIED MODEL
    ...
    while True:
        ...
        # Assuming preprocessing is a function you have defined
            ...
            camera.imshow("Processed Image", img)
        ...
        # Ensure img is converted to grayscale if needed and has the correct shape
            ...
            camera.putText(imgOrignal, "CLASS: ", (20, 35), font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
            camera.putText(imgOrignal, "PROBABILITY: ", (20, 75), font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
        ...
        # PREDICT IMAGE
            ...
            # Assuming getClassName is a function that returns the class name based on the class index
                ...
                camera.putText(imgOrignal, str(classIndex) + " " + str(class_name), (120, 35), font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
                camera.putText(imgOrignal, str(round(probabilityValue * 100, 2)) + "%", (180, 75), font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
